...
var PhotoImageDataAccess = exports.PhotoImageDataAccess = function () {
    ...
    PhotoImageDataAccess.prototype.findPathsRequiringMovement = function () {
        var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9() {
            var results, paths, _iterator, _isArray, _i, _ref10, result, ids;
            ...
            return regeneratorRuntime.wrap(function _callee9$(_context9) {
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 20:
                            return _context9.abrupt("return", paths);
    ...
    PhotoImageDataAccess.prototype.findImagesRequiringMovement = function () {
        var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(directoryPath) {
    ...
    PhotoImageDataAccess.prototype.getDiff = function () {
        var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(directoryPath, filenames) {
            ...
            return regeneratorRuntime.wrap(function _callee11$(_context11) {
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        ...
                        case 2:
                            indexedResults = _context11.sent;
                            result = {
                                new: [],
                                deleted: []
                            };
                ...
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        ...
                        case 2:
                            ...
                            return _context12.abrupt("return", groups.map(function (g) {
                                return {
                                    directoryPath: g._id,
                                    imageCount: g.count
                                };
    ...
    PhotoImageDataAccess.prototype.cleanExcept = function () {
        var _ref14 = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(directoryPath, filenames) {
    ...
    PhotoImageDataAccess.prototype.invalidateImageIds = function () {
        var _ref16 = _asyncToGenerator(regeneratorRuntime.mark(function _callee15(ids) {
    ...
    PhotoImageDataAccess.prototype.invalidateImage = function () {
        var _ref17 = _asyncToGenerator(regeneratorRuntime.mark(function _callee16(directoryPath, filename) {
    ...
    PhotoImageDataAccess.prototype.invalidateImages = function () {
        var _ref18 = _asyncToGenerator(regeneratorRuntime.mark(function _callee17(directoryPath) {
    ...
    PhotoImageDataAccess.prototype.upsertImage = function () {
        var _ref19 = _asyncToGenerator(regeneratorRuntime.mark(function _callee18(directoryPath, filename, imageProperties /* Can be null */) {
            var image;
    ...
    PhotoImageDataAccess.prototype.updateLocation = function () {
        var _ref20 = _asyncToGenerator(regeneratorRuntime.mark(function _callee19(id, directoryPath, filename) {
            var image;
            ...
            return regeneratorRuntime.wrap(function _callee20$(_context20) {
                while (1) {
                    switch (_context20.prev = _context20.next) {
                        ...
                        case 2:
                            groups = _context20.sent;
                            return _context20.abrupt("return", groups.map(function (group) {
                                return group._id;
                            }));
    ...
    PhotoImageDataAccess.prototype.combineDuplicateHistories = function () {
        var _ref22 = _asyncToGenerator(regeneratorRuntime.mark(function _callee21(ids) {
            var _this = this;

            var duplicates, hash, allPathHistoryEvents, uniquePathHistoryEvents, lastEvent, _iterator2, _isArray2, _i2, _ref23, pathHistoryEvent, updatePromises, _iterator3, _isArray3, _i3, _ref24, duplicate;
                ...
                while (1) {
                    switch (_context21.prev = _context21.next) {
                        ...
                        case 8:
                            ...
                            lastEvent = null;
                            _iterator2 = allPathHistoryEvents, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();

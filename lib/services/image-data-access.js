...
var ImageDataAccess = exports.ImageDataAccess = function () {
    ...
    ImageDataAccess.prototype.getByIds = function () {
    ...
    ImageDataAccess.prototype.getByHash = function () {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            _context3.next = 2;
                            return this._imageInfos.find({ hash: hash });
    ...
    ImageDataAccess.prototype.findUnreadable = function () {
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            _context4.next = 2;
                            return this._imageInfos.find({ properties: null });
    ...
    ImageDataAccess.prototype.findMissingTakenDate = function () {
            ...
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            _context5.next = 2;
                            return this._imageInfos.find({ "properties.takenDateTime": null });
    ...
    ImageDataAccess.prototype.getDiff = function () {
        var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(directoryPath, filenames) {
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 2:
                            ...
                            return _context7.abrupt("return", groups.map(function (g) {
                                return {
                                    directoryPath: g._id,
                                    imageCount: g.count
                                };
    ...
    ImageDataAccess.prototype.getImageFilenames = function () {
        var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(directoryPath) {
            var images;
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        ...
                        case 3:
                            ...
                            return _context8.abrupt("return", images.map(function (i) {
                                return i.filename;
                            }));
        ...
        function getImageFilenames(_x6) {
    ...
    ImageDataAccess.prototype.invalidateImageIds = function () {
            ...
            return regeneratorRuntime.wrap(function _callee10$(_context10) {
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        case 0:
                            _context10.next = 2;
                            return this._imageInfos.update({ _id: { $in: ids } }, { $set: { valid: false } }, { multi: true });
        ...
        function invalidateImageIds(_x9) {
    ...
    ImageDataAccess.prototype.invalidateImage = function () {
        var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(directoryPath, filename) {
        ...
        function invalidateImage(_x10, _x11) {
    ...
    ImageDataAccess.prototype.invalidateImages = function () {
        var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(directoryPath) {
        ...
        function invalidateImages(_x12) {
    ...
    ImageDataAccess.prototype.upsertImage = function () {
        var _ref13 = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(directoryPath, filename, imageProperties /* Can be null */) {
            var image;
        ...
        function upsertImage(_x13, _x14, _x15) {
    ...
    ImageDataAccess.prototype.listDuplicateHashes = function () {
            ...
            return regeneratorRuntime.wrap(function _callee14$(_context14) {
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        case 0:
                            _context14.next = 2;
                            return this._imageInfos.aggregate([{ $match: { hash: { $ne: null } } }, { $group: { _id: "$hash", count: { $sum: 1 } } }, { $match: { count: { $gt: 1 } } }, { $sort: { count: -1 } }]);

                        case 2:
                            groups = _context14.sent;
                            return _context14.abrupt("return", groups.map(function (group) {
                                return group._id;
                            }));
    ...
    ImageDataAccess.prototype.combineDuplicateHistories = function () {
        var _ref15 = _asyncToGenerator(regeneratorRuntime.mark(function _callee15(ids) {
            var _this = this;

            var duplicates, hash, allPathHistoryEvents, uniquePathHistoryEvents, lastEvent, _iterator, _isArray, _i, _ref16, pathHistoryEvent, updatePromises, _loop, _iterator2, _isArray2, _i2, _ref17, _ret;
                    ...
                    switch (_context15.prev = _context15.next) {
                        ...
                        case 26:
                            ...
                            _loop = function _loop() {
                                ...
                                updatePromises.push(_this._imageInfos.update({ _id: duplicate._id }, duplicate));
                            };
        ...
        function combineDuplicateHistories(_x16) {

...
var setPropertiesForImageInfos = function () {
    var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(exifTool, imageInfos) {
        var filePaths, imageInfoLookup, allFilesPropertyLookup, _iterator2, _isArray2, _i2, _ref11, filePath, filePropertyLookup, _filePath, imageInfo;
            ...
            while (1) {
                switch (_context9.prev = _context9.next) {
                    case 0:
                        ...
                        imageInfos.forEach(function (i) {
                            var filePath = _path2.default.join(i.directoryPath, i.filename);
                    ...
                    case 26:
                        ...
                        for (_filePath in allFilesPropertyLookup) {
                            ...
                            imageInfo.properties = allFilesPropertyLookup[_filePath]; // Can be null for unreadable files
                        }
...
var PhotoIndexServices = exports.PhotoIndexServices = function () {
    function PhotoIndexServices(exifTool, imageDataAccess, fileFinder, photoBaseDirectories) {
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            _context4.next = 2;
                            return this._imageDataAccess.invalidateImageIds(ids);
            ...
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            _context5.next = 2;
                            return this._imageDataAccess.getByPath(directoryPath);
                        ...
                        case 13:
                            imagePromises = imageInfos.map(function (i) {
                                return _this2._imageDataAccess.upsertImage(i.directoryPath, i.filename, i.properties);
                            });
                            _context5.next = 16;
            ...
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            _context6.next = 2;
                            return this._imageDataAccess.getByIds(ids);
                        ...
                        case 6:
                            imagePromises = imageInfos.map(function (i) {
                                return _this3._imageDataAccess.upsertImage(i.directoryPath, i.filename, i.properties);
                            });
                            _context6.next = 9;
                            return Promise.all(imagePromises);
            ...
            return regeneratorRuntime.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            _context8.next = 2;
                            return this._imageDataAccess.cleanIds(ids);

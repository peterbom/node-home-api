                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        ...
                        case 2:
                            ...
                            reindexFile = function () {
                                var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(filename) {
                                    var filePath, properties;
                                    return regeneratorRuntime.wrap(function _callee3$(_context3) {
                                        while (1) {
                                            switch (_context3.prev = _context3.next) {
                                                case 0:
                                                    filePath = _path2.default.join(directory, filename);
                                                    _context3.next = 3;
                                                    return _this2._exifTool.getProperties(filePath);

                                                case 3:
                                                    properties = _context3.sent;
                                                    _context3.next = 6;
                                                    return _this2._imageDataAccess.upsertImage(directory, filename, properties);
                                ...
                                return function reindexFile(_x2) {
                                    return _ref5.apply(this, arguments);
                                };
                            }();

                            _context4.next = 6;
                            return Promise.all(files.map(reindexFile));

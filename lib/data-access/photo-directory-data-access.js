...
var getFilePropertyLookup = function () {
    var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(exifTool, directory, filenames) {
        var filePaths, filePropertyLookup, results, _iterator, _isArray, _i, _ref6, filename, filePath;
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    ...
                    case 5:
                        filePropertyLookup = _context5.sent;
                        ...
                        return _context5.abrupt("return", filePropertyLookup);

                    case 8:

                        // Reading all files failed. Attempt them one-by-one
                        results = {};
                        _iterator = filenames, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();
                    ...
                    case 20:
                        filename = _ref6;
                        filePath = _path3.default.join(directory, filename);
                        _context5.next = 24;
    ...
    return function getFilePropertyLookup(_x3, _x4, _x5) {
                        ...
                        case 2:
                            ...
                            reindexFiles = function () {
                                var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(filenames) {
                                    var filePropertyLookup, imagePromises, filename, properties;
                                    return regeneratorRuntime.wrap(function _callee3$(_context3) {
                                        while (1) {
                                            switch (_context3.prev = _context3.next) {
                                                case 0:
                                                    _context3.next = 2;
                                                    return getFilePropertyLookup(_this2._exifTool, directory, filenames);

...
var _findFiles = function () {
    var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(baseDirectory, skipDirectoryRegexes, fileMatchRegex) {
    ...
    return function _findFiles(_x6, _x7, _x8) {
        return _ref3.apply(this, arguments);
    };
}();

var _findDirectories = function () {
    var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(baseDirectory, skipDirectoryRegexes) {
                    ...
                    case 0:
                        ...
                        return new Promise(function (fulfill, reject) {
                            ...
                            walker.on("directories", function (root, dirStatsArray, next) {
                                dirStatsArray = dirStatsArray.filter(function (stat) {
                                    return !skipDirectoryRegexes.some(function (regex) {
                                        return regex.test(stat.name);
                                    });
                                });
    ...
    return function _findDirectories(_x9, _x10) {
...
var FileFinder = exports.FileFinder = function () {
    ...
    FileFinder.prototype.findDirectories = function () {
        var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(baseDirectories, skipDirectoryRegexes) {

...
var ExifTool = exports.ExifTool = function () {
    ...
    ExifTool.prototype.getProperties = function () {
        var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(filePath) {
            var properties, command, output, info, takenDateTimeString, takenDateTime, fileModifyDate, camera, tags, keywordTags, i, keyword;
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            properties = ["-DateTimeOriginal", "-CreateDate", "-DateTime1", "-DateTime2", "-MediaCreateDate", "-FileModifyDate", "-Make", "-Model", "-Software", "-CreatorTool", "-FileType", "-FileSize", "-ImageWidth", "-ImageHeight", "-Subject", "-Keywords"];
                            command = "perl " + this._toolPath + " -s -j " + properties.join(" ") + " \"" + filePath + "\"";
                            _context3.next = 4;
                            return exec(command);
                        ...
                        case 9:
                            info = JSON.parse(output.stdout)[0];

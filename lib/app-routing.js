...
exports.getPhotoFrameRouteGenerator = getPhotoFrameRouteGenerator;
exports.getFileRouteGenerator = getFileRouteGenerator;
exports.getMachineStatusRouteGenerator = getMachineStatusRouteGenerator;
exports.getPlantRouteGenerator = getPlantRouteGenerator;
exports.getPlantCompanionRouteGenerator = getPlantCompanionRouteGenerator;
exports.getPlantReferenceRouteGenerator = getPlantReferenceRouteGenerator;
...
function getPhotoIndexRouteGenerator(permissionDataAccess, photoIndexResource) {
    ...
    return _routeGenerator.RouteGenerator.create(permissionDataAccess, "home").get("/photo-index", function (ctx) {
        return photoIndexResource.listDirectories(ctx);
    }, "manage").get("/photo-index/:path", function (ctx) {
...
function getPhotoFrameRouteGenerator(permissionDataAccess, photoFrameResource) {
    if (photoFrameResource === undefined) {
        throw new Error("photoFrameResource not defined");
    }

    return _routeGenerator.RouteGenerator.create(permissionDataAccess, "home").get("/photo-frame", function (ctx) {
        return photoFrameResource.list(ctx);
    }, "manage").post("/photo-frame", function (ctx) {
        return photoFrameResource.addImages(ctx);
    }, "manage").delete("/photo-frame", function (ctx) {
        return photoFrameResource.clearImages(ctx);
    }, "manage");
}
...
function getPlantRouteGenerator(permissionDataAccess, plantResource) {
    if (plantResource === undefined) {
        throw new Error("plantResource not defined");
    }

    return _routeGenerator.RouteGenerator.create(permissionDataAccess, "home").get("/plant", function (ctx) {
        return plantResource.listPlants(ctx);
    }, "manage").get("/plant-link", function (ctx) {
        return plantResource.listLinks(ctx);
    }, "manage").put("/plant/:tsn", function (ctx) {
        return plantResource.set(ctx);
    }, "manage");
}

function getPlantCompanionRouteGenerator(permissionDataAccess, plantCompanionResource) {
    if (plantCompanionResource === undefined) {
        throw new Error("plantCompanionResource not defined");
    }

    return _routeGenerator.RouteGenerator.create(permissionDataAccess, "home").get("/plant-companion", function (ctx) {
        return plantCompanionResource.list(ctx);
    }, "manage").put("/plant-companion/:tsn", function (ctx) {
        return plantCompanionResource.set(ctx);
    }, "manage").delete("/plant-companion/:tsn", function (ctx) {
        return plantCompanionResource.delete(ctx);
    }, "manage");
}

function getPlantReferenceRouteGenerator(permissionDataAccess, plantReferenceResource) {
    if (plantReferenceResource === undefined) {
        throw new Error("plantReferenceResource not defined");
    }

    return _routeGenerator.RouteGenerator.create(permissionDataAccess, "home").get("/plant-reference/companion-help", function (ctx) {
        return plantReferenceResource.listCompanionHelp(ctx);
    }, "manage").get("/plant-reference/companion-hinder", function (ctx) {
        return plantReferenceResource.listCompanionHinder(ctx);
    }, "manage").put("/plant-reference/companion-help/:tsn1/:tsn2", function (ctx) {
        return plantReferenceResource.addCompanionHelpReference(ctx);
    }, "manage").put("/plant-reference/companion-hinder/:tsn1/:tsn2", function (ctx) {
        return plantReferenceResource.addCompanionHinderReference(ctx);
    }, "manage").delete("/plant-reference/:id", function (ctx) {
        return plantReferenceResource.deleteReference(ctx);
    }, "manage");
}
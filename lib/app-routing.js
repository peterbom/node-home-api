...
exports.getPlantViewRouteGenerator = getPlantViewRouteGenerator;
exports.getPlantMaintainRouteGenerator = getPlantMaintainRouteGenerator;
...
function getPlantViewRouteGenerator(plantResource, plantCompanionResource, plantReferenceResource) {
    ...
    return _routeGenerator.RouteGenerator.create().get("/plant", function (ctx) {
        return plantResource.listPlants(ctx);
    }).get("/plant-link", function (ctx) {
        return plantResource.listLinks(ctx);
    }).get("/plant-companion", function (ctx) {
        return plantCompanionResource.list(ctx);
    }).get("/plant-reference/companion-help", function (ctx) {
        return plantReferenceResource.listCompanionHelp(ctx);
    }).get("/plant-reference/companion-hinder", function (ctx) {
        return plantReferenceResource.listCompanionHinder(ctx);
    });
}

function getPlantMaintainRouteGenerator(permissionDataAccess, plantResource, plantCompanionResource, plantReferenceResource) {

    if (plantResource === undefined) throw new Error("plantResource not defined");
    if (plantCompanionResource === undefined) throw new Error("plantCompanionResource not defined");
    if (plantReferenceResource === undefined) throw new Error("plantReferenceResource not defined");

    return _routeGenerator.RouteGenerator.create(permissionDataAccess, "home").put("/plant/:tsn", function (ctx) {

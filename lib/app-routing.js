...
exports.getPhotoThumbnailRouteGenerator = getPhotoThumbnailRouteGenerator;
...
function getPhotoThumbnailRouteGenerator(permissionDataAccess, photoThumbnailResource) {
    if (photoThumbnailResource === undefined) {
        throw new Error("photoThumbnailResource not defined");
    }

    return _routeGenerator.RouteGenerator.create(permissionDataAccess, "home").get("/photo-thumbnail/:id", function (ctx) {
        return photoThumbnailResource.get(ctx);
    }, "manage");
}

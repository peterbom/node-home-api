...
var AppLauncher = exports.AppLauncher = function () {
    ...
    AppLauncher.launch = function launch(components) {
        ...
        _log.Log.logger = components.logger;
        ...
        app.use(components.middleware.userUpdater || _nullMiddleware.noop);
        ...
        if (!settings.isUnitTest) {
            ...
            _log.Log.info("Application started. Listening on port: " + settings.port);
        }
    };

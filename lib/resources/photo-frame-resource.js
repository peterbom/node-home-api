...
var PhotoFrameResource = exports.PhotoFrameResource = function () {
    ...
    PhotoFrameResource.prototype.addImages = function () {
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            _context2.next = 3;
                            return this._photoFrameServices.addImages(ids);
    ...
    PhotoFrameResource.prototype.clearImages = function () {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            _context3.next = 2;
                            return this._photoFrameServices.clearImages();

...
var _exifTool = require("./data-access/exif-tool");
...
var _imageDataAccess = require("./data-access/image-data-access");

var _photoDirectoryDataAccess = require("./data-access/photo-directory-data-access");
...
var _photoDirectoryResource = require("./resources/photo-directory-resource");
...
function getDefaultComponents() {
    ...
    components.photoDirectoryDataAccess = new _photoDirectoryDataAccess.PhotoDirectoryDataAccess(components.exifTool, components.imageDataAccess, components.fileFinder, [settings.stagingPhotoPath, settings.targetPhotoPath]);
    ...
    components.photoDirectoryResource = new _photoDirectoryResource.PhotoDirectoryResource(components.photoDirectoryDataAccess);
    ...
    components.middleware = {
        ...
        securedRouteGenerators: [routing.getUserRouteGenerator(components.permissionDataAccess, components.userResource), routing.getPhotoDirectoryRouteGenerator(components.permissionDataAccess, components.photoDirectoryResource), routing.getStagingPhotoRouteGenerator(components.permissionDataAccess, components.stagingPhotoResource), routing.getPhotoMovementRouteGenerator(components.permissionDataAccess, components.photoMovementResource), routing.getMachineStatusRouteGenerator(components.permissionDataAccess, components.machineStatusResource)]
    };

...
function getDefaultComponents() {
    ...
    components.photoDirectoryDataAccess = new _photoDirectoryDataAccess.PhotoDirectoryDataAccess(components.fileFinder, [settings.stagingPhotoPath, settings.targetPhotoPath]);

...
function getDefaultComponents() {
    ...
    components.photoIndexServices = new _photoIndexServices.PhotoIndexServices(components.exifTool, components.imageDataAccess, components.fileFinder, [settings.stagingPhotoPath, settings.targetPhotoPath]);

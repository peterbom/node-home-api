...
var _imageUtils = require("./shared/image-utils");
...
var _photoUploadDataAccess = require("./services/photo-upload-data-access");

var _plantDataAccess = require("./services/plant-data-access");

var _plantCompanionDataAccess = require("./services/plant-companion-data-access");

var _plantReferenceDataAccess = require("./services/plant-reference-data-access");
...
var _photoUploadServices = require("./services/photo-upload-services");

var _photoFrameServices = require("./services/photo-frame-services");
...
var _photoUploadResource = require("./resources/photo-upload-resource");

var _photoFrameResource = require("./resources/photo-frame-resource");

var _fileResource = require("./resources/file-resource");

var _machineStatusResource = require("./resources/machine-status-resource");

var _plantResource = require("./resources/plant-resource");

var _plantCompanionResource = require("./resources/plant-companion-resource");

var _plantReferenceResource = require("./resources/plant-reference-resource");
...
// Shared components
var envVars = require("./shared/env-utils");

// Services

var SshServices = require("./services/ssh-services");
...
function getDefaultComponents() {
    ...
    components.dbManager.id = _monk2.default.id;
    components.dbManager.options = {
        safe: true,
        castIds: false
    };

    components.imageUtils = new _imageUtils.ImageUtils(settings.targetPhotoPath);
    ...
    components.sshServices = new SshServices(settings.sshHost, settings.sshPort, settings.sshUsername, settings.sshPrivateKeyPath, settings.localRoot, settings.serverRoot);
    ...
    components.photoImageDataAccess = new _photoImageDataAccess.PhotoImageDataAccess(components.dbManager, components.imageUtils);
    components.photoUploadDataAccess = new _photoUploadDataAccess.PhotoUploadDataAccess(components.dbManager);
    components.plantDataAccess = new _plantDataAccess.PlantDataAccess(components.dbManager);
    components.plantCompanionDataAccess = new _plantCompanionDataAccess.PlantCompanionDataAccess(components.dbManager);
    components.plantReferenceDataAccess = new _plantReferenceDataAccess.PlantReferenceDataAccess(components.dbManager);

    components.photoIndexServices = new _photoIndexServices.PhotoIndexServices(components.exifTool, components.photoImageDataAccess, components.fileServices, [settings.stagingPhotoPath, settings.targetPhotoPath]);
    ...
    components.photoMovementServices = new _photoMovementServices.PhotoMovementServices(components.photoImageDataAccess, components.fileServices, components.sshServices, components.imageUtils);
    components.photoUploadServices = new _photoUploadServices.PhotoUploadServices(components.photoUploadDataAccess, settings.stagingPhotoPath);
    components.photoFrameServices = new _photoFrameServices.PhotoFrameServices(components.photoImageDataAccess, settings.machineLookup.flash.ipAddress);
    ...
    components.photoUploadResource = new _photoUploadResource.PhotoUploadResource(components.photoUploadServices);
    components.photoFrameResource = new _photoFrameResource.PhotoFrameResource(components.photoFrameServices);
    ...
    components.plantResource = new _plantResource.PlantResource(components.plantDataAccess);
    components.plantCompanionResource = new _plantCompanionResource.PlantCompanionResource(components.plantCompanionDataAccess);
    components.plantReferenceResource = new _plantReferenceResource.PlantReferenceResource(components.plantReferenceDataAccess);
    ...
    components.middleware = {
        ...
        unsecuredRouteGenerators: [routing.getPermissionRouteGenerator(components.permissionResource), routing.getPlantViewRouteGenerator(components.plantResource, components.plantCompanionResource, components.plantReferenceResource)],

        authorizationChecker: _authorizationMiddleware.authorizationChecker,

        securedRouteGenerators: [routing.getUserRouteGenerator(components.permissionDataAccess, components.userResource), routing.getPhotoIndexRouteGenerator(components.permissionDataAccess, components.photoIndexResource), routing.getPhotoDuplicateRouteGenerator(components.permissionDataAccess, components.photoDuplicateResource), routing.getPhotoExifDataRouteGenerator(components.permissionDataAccess, components.photoExifDataResource), routing.getPhotoImageRouteGenerator(components.permissionDataAccess, components.photoImageResource), routing.getPhotoMovementRouteGenerator(components.permissionDataAccess, components.photoMovementResource), routing.getPhotoUploadRouteGenerator(components.permissionDataAccess, components.photoUploadResource), routing.getPhotoFrameRouteGenerator(components.permissionDataAccess, components.photoFrameResource), routing.getFileRouteGenerator(components.permissionDataAccess, components.fileResource), routing.getMachineStatusRouteGenerator(components.permissionDataAccess, components.machineStatusResource), routing.getPlantMaintainRouteGenerator(components.permissionDataAccess, components.plantResource, components.plantCompanionResource, components.plantReferenceResource)]
    };

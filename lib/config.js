...
function getDefaultComponents() {
    ...
    components.photoMovementServices = new _photoMovementServices.PhotoMovementServices(components.photoImageDataAccess, components.fileServices, components.imageUtils);

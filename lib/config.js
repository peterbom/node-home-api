...
function getDefaultComponents(settings) {
    ...
    components.middleware = {
        ...
        tokenParser: _tokenParsingMiddleware.bearerTokenParser,

        unsecuredRoutes: [routingMiddleware.getAuthenticationRouter(components.authenticationResource)],

        authorizationChecker: _authorizationMiddleware.authorizationChecker,

        securedRoutes: [routingMiddleware.getUserRouter(components.userResource), routingMiddleware.getStagingPhotoRouter(components.stagingPhotoResource), routingMiddleware.getPhotoMovementRouter(components.photoMovementResource), routingMiddleware.getPackagingConstructionStyleRouter(components.packagingConstructionStyleResource)]
    };

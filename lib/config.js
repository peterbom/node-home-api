...
var _stagingPhotoDataAccess = require("./services/staging-photo-data-access");
...
function getDefaultComponents() {
    ...
    components.logger = settings.isUnitTest ? console : _winston2.default;
    ...
    components.stagingPhotoDataAccess = new _stagingPhotoDataAccess.StagingPhotoDataAccess(components.exifTool, components.imageDataAccess, components.fileFinder, settings.stagingPhotoPath);

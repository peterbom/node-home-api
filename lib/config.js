...
function getDefaultComponents() {
    ...
    components.photoDirectoryDataAccess = new _photoDirectoryDataAccess.PhotoDirectoryDataAccess(components.imageDataAccess, components.fileFinder, [settings.stagingPhotoPath, settings.targetPhotoPath]);

...
var _imageDataAccess = require("./services/image-data-access");

var _photoSyncServices = require("./services/photo-sync-services");
...
var _photoSyncResource = require("./resources/photo-sync-resource");
...
function getDefaultComponents() {
    ...
    components.imageDataAccess = new _imageDataAccess.ImageDataAccess(components.dbManager);
    components.photoSyncServices = new _photoSyncServices.PhotoSyncServices(components.exifTool, components.imageDataAccess, components.fileFinder, [settings.stagingPhotoPath, settings.targetPhotoPath]);
    components.photoDuplicateServices = new _photoDuplicateServices.PhotoDuplicateServices(components.exifTool, components.imageDataAccess);
    components.photoExifDataServices = new _photoExifDataServices.PhotoExifDataServices(components.exifTool, components.imageDataAccess);
    components.photoImageServices = new _photoImageServices.PhotoImageServices(components.imageDataAccess);
    ...
    components.photoSyncResource = new _photoSyncResource.PhotoSyncResource(components.photoSyncServices);
    ...
    components.middleware = {
        ...
        securedRouteGenerators: [routing.getUserRouteGenerator(components.permissionDataAccess, components.userResource), routing.getPhotoSyncRouteGenerator(components.permissionDataAccess, components.photoSyncResource), routing.getPhotoDuplicateRouteGenerator(components.permissionDataAccess, components.photoDuplicateResource), routing.getPhotoExifDataRouteGenerator(components.permissionDataAccess, components.photoExifDataResource), routing.getPhotoImageRouteGenerator(components.permissionDataAccess, components.photoImageResource), routing.getPhotoMovementRouteGenerator(components.permissionDataAccess, components.photoMovementResource), routing.getMachineStatusRouteGenerator(components.permissionDataAccess, components.machineStatusResource)]
    };
